...
**All three default demo worlds — Current (500 × 500), Bigger (2,500 × 2,500), and Massive (16,000 × 16,000) — now contain an **independent** expansive dirt continent centered in the previously mostly-ocean expanse, with an elliptical target footprint of approximately one third of the total map area. It does **not** recolor one third of the existing small authored islands. Their original ground/elevation arrays are kept untouched, and the sparse dirt sampling excludes protected areas around them. The original authored island cells and heights are preserved at every size; the separate procedural ground is sampled only where the source map has ocean. Imported user Tiled maps remain unchanged unless a creator explicitly opts into future procedural expansion support.
