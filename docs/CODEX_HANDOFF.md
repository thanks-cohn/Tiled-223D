...
**Read [CODEX_DIRT_LANDMASS_SYSTEM_REQUEST.md](CODEX_DIRT_LANDMASS_SYSTEM_REQUEST.md) in full, then [API/Dirt/README.md](../API/Dirt/README.md), [API/Dirt/COMMANDS.md](../API/Dirt/COMMANDS.md), and [API/Dirt/DEBUGGING.md](../API/Dirt/DEBUGGING.md).** The complete canonical landmass and fixed-ramp design, including generate-once/stream-on-demand and agent recommendations, remains in [the shared proposal](../portable-visions/AEXIS_CANONICAL_DIRT_LANDMASS_FIXED_FEATURES_EXPANDABLE_SPACING_PROPOSAL.md). This is the **active specification to implement**, not a statement that those API commands or the correct terrain interpreter are already shipped.
